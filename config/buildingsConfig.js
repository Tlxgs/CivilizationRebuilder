...
BUILDINGS_CONFIG = {
    ...
    "伐木场": {
        ...
        cost: (state, count) => standardCost({木头: 10}, 1.2, count, getGlobalCostMultiplier(state)),
        produces: {木头: 0.5},
        desc: "生产木材"
    },
    "采石场": {
        ...
        cost: (state, count) => standardCost({木头: 5, 石头: 5}, 1.2, count, getGlobalCostMultiplier(state)),
        produces: {石头: 0.5},
        desc: "开采石头"
    },
    "仓库": {
    ...
    "大型煤矿": {
        ...
        cost: (state, count) => standardCost({建材: 20, 木头: 200}, 1.3, count, getGlobalCostMultiplier(state)),
        consumes: {电力: 0.4},
        caps: {煤:100},
        desc: "提供煤储存，同时使煤矿产量+15%",
        modifiers: [
            { target: "煤矿", prodFactor: 0.15 }
        ]
    },
    "工具加工站": {
        type: "生产",
        unlockCondition: { tech: "铁制工具" },
        cost: (state, count) => standardCost({铁: 500, 石头: 500}, 1.4, count, getGlobalCostMultiplier(state)),
        consumes: {电力: 0.5},
        desc: "制造工具来提高伐木场和采石场产量",
        modifiers: [
            { target: "伐木场", prodFactor: 0.05 },
            { target: "采石场", prodFactor: 0.05 }
        ]
    },
    "金矿": {
        type: "生产",
    ...
    "铜冶炼厂": {
        ...
        happiness: -0.2,
        cost: (state, count) => standardCost({石头: 50}, 1.2, count, getGlobalCostMultiplier(state)),
    ...
    "铁冶炼厂": {
        ...
        happiness: -0.2,
        cost: (state, count) => standardCost({石头: 40, 铜: 20}, 1.2, count, getGlobalCostMultiplier(state)),
    ...
    "博物馆": {
        ...
        cost: (state, count) => standardCost({石头: 300, 铜: 150}, 1.4, count, getGlobalCostMultiplier(state)),
    ...
    "科学院": {
        ...
        cost: (state, count) => standardCost({塑料: 30, 金属板: 30}, 1.3, count, getGlobalCostMultiplier(state)),
        consumes: {电力: 0.5},
        desc: "提供先进理论，使大学科学产出和上限+10%",
        modifiers: [
            { target: "大学", prodFactor: 0.1, capFactor: 0.1 }
        ]
    },
    "暗物质研究所": {
        type: "太空",
        unlockCondition: { tech: "暗物质利用" },
        cost: (state, count) => standardCost({钛:5000, 碳纤维:500, 科学:500}, 1.15, count, getGlobalCostMultiplier(state)),
    ...
    "蒸汽机": {
        ...
        cost: (state, count) => standardCost({石头: 100, 铁: 20}, 1.2, count, getGlobalCostMultiplier(state)),
    ...
    "建材工厂": {
        ...
        unlockCondition: { tech: "初级建筑学" },
        happiness: -0.4,
        cost: (state, count) => standardCost({铁: 50, 木头: 200}, 1.2, count, getGlobalCostMultiplier(state)),
        produces: {建材: 0.3}, consumes: {木头: 6, 石头: 3, 铁: 0.5, 电力: 0.5},
        caps: {建材: 100},
        desc: "生产建材"
    },
    "炼钢厂": {
        ...
        happiness: -0.4,
        cost: (state, count) => standardCost({建材: 30, 铜: 100}, 1.3, count, getGlobalCostMultiplier(state)),
    ...
    "电解铝厂": {
        ...
        happiness: -0.4,
        cost: (state, count) => standardCost({建材: 30, 钢: 40}, 1.3, count, getGlobalCostMultiplier(state)),
    ...
    "金属加工厂": {
        ...
        happiness: -0.4,
        cost: (state, count) => standardCost({建材: 50, 铁: 100}, 1.25, count, getGlobalCostMultiplier(state)),
        produces: {金属板: 0.2}, consumes: {电力: 0.5, 铜: 1.5, 铝: 0.5},
        caps: {金属板: 100},
        desc: "生产金属板"
    },
    "金属回收厂": {
        ...
        happiness: -0.4,
        cost: (state, count) => standardCost({建材: 50, 金属板: 100}, 1.20, count, getGlobalCostMultiplier(state)),
    ...
    "塑料厂": {
        ...
        happiness: -0.4,
        cost: (state, count) => standardCost({金属板: 30, 建材: 30}, 1.20, count, getGlobalCostMultiplier(state)),
    ...
    "碳纤维厂": {
        ...
        happiness: -0.4,
        cost: (state, count) => standardCost({金属板: 200, 塑料: 100}, 1.15, count, getGlobalCostMultiplier(state)),
    ...
    "核燃料工厂": {
        ...
        happiness: -0.4,
        cost: (state, count) => standardCost({金属板: 150, 铁: 400}, 1.15, count, getGlobalCostMultiplier(state)),
    ...
    "油田": {
        ...
        cost: (state, count) => standardCost({金属板: 50, 钢: 30}, 1.2, count, getGlobalCostMultiplier(state)),
    ...
    "太阳能板": {
        ...
        cost: (state, count) => standardCost({塑料: 30, 铜: 200}, 1.08, count, getGlobalCostMultiplier(state)),
        produces: (state) => {
    ...
    "铀矿": {
        ...
        cost: (state, count) => standardCost({铁: 300, 建材: 150}, 1.2, count, getGlobalCostMultiplier(state)),
        produces: {铀: 0.3}, caps: {铀: 50},
        desc: "开采铀"
    },
    "裂变反应堆": {
        type: "电力",
        unlockCondition: { tech: "核裂变" },
        cost: (state, count) => standardCost({金属板: 100, 铀: 30}, 1.2, count, getGlobalCostMultiplier(state)),
        caps: {铀: 100},
        desc: "核能发电，可切换燃料模式",
        modes: [
            {
    ...
    "粒子加速器": {
        ...
        cost: (state, count) => standardCost({金属板:500, 建材:500, 科学:500}, 1.2, count, getGlobalCostMultiplier(state)),
    ...
    "轨道电梯": {
        ...
        cost: (state, count) => standardCost({碳纤维: 5000, 钛: 3000, 金属板: 8000}, 1.15, count, getGlobalCostMultiplier(state)),
        consumes: {电力: 0.8},
    ...
    "月球基地": {
        ...
        cost: (state, count) => {
            ...
            const discount = Math.pow(0.99, elevatorActive);
            const price = {};
        ...
        produces: {太空宜居度: 1.0}, consumes: {电力: 2.0},
        caps: {铀:500, 钛:500, 碳纤维:500, 核燃料:200, 太空宜居度:100},
        desc: "月球殖民"
    },
    "气态行星基地": {
        type: "太空",
        unlockCondition: { tech: "探索气态行星" },
        cost: (state, count) => standardCost({钛: 10000, 塑料: 5000}, 1.15, count, getGlobalCostMultiplier(state)),
        produces: {太空宜居度: 0.3}, consumes: {电力: 0.8},
        caps: {氚:300, 核燃料:300, 太空宜居度:50},
        modifiers: [
    ...
    "月球铁矿": {
        ...
        cost: (state, count) => standardCost({钢: 50, 碳纤维: 150}, 1.20, count, getGlobalCostMultiplier(state)),
        produces: {铁: 1.5}, consumes: {电力: 1.0, 太空宜居度: 1.0}, caps: {铁:100},
        desc: "月球铁矿"
    },
    "月球铜矿": {
        type: "太空",
        unlockCondition: { tech: "基础月球采矿" },
        cost: (state, count) => standardCost({铝: 50, 碳纤维: 150}, 1.20, count, getGlobalCostMultiplier(state)),
        produces: {铜: 2.0}, consumes: {电力: 0.8, 太空宜居度: 1.0}, caps: {铜:100},
        desc: "月球铜矿"
    },
    "月球钛矿": {
        type: "太空",
        unlockCondition: { tech: "进阶月球采矿" },
        cost: (state, count) => standardCost({金属板: 100, 碳纤维: 250}, 1.2, count, getGlobalCostMultiplier(state)),
        produces: {钛: 0.5}, consumes: {电力: 1.2, 太空宜居度: 1.5}, caps: {钛: 100},
        desc: "月球钛矿"
    },
    "月球研究所": {
        type: "太空",
        unlockCondition: { tech: "研究月球" },
        cost: (state, count) => standardCost({钛: 250, 钢: 400}, 1.25, count, getGlobalCostMultiplier(state)),
        produces: {科学: 0.1}, consumes: {电力: 1.0, 太空宜居度: 1.0},
        caps: {科学: 200},
        desc: "月球科研建筑"
    },
    "月球工厂": {
    ...
    "聚变反应堆": {
        ...
        cost: (state, count) => standardCost({金属板: 10000, 碳纤维: 5000, 核燃料: 1000}, 1.12, count, getGlobalCostMultiplier(state)),
        produces: {电力: 3},
        consumes: {核燃料: 0.50},
        desc: "通过核聚变产生大量清洁能源"
    },
    "太空剧院": {
        ...
        cost: (state, count) => standardCost({金属板: 500, 塑料: 500}, 1.25, count, getGlobalCostMultiplier(state)),
        produces: {},
        consumes: {电力: 0.4, 科学: 2},
        caps: {},
        happiness: (state) => {
