...
BUILDINGS_CONFIG = {
    ...
    "煤矿": {
        ...
        basePrice: {石头: 100}, costGrowth: 1.20,
        produces: {煤: 0.2},
        desc: "生产少量煤"
    },
    "大型煤矿": {
        ...
        basePrice: {建材: 20,木头: 200}, costGrowth: 1.15,
        consumes: {电力: 0.2}, 
        caps: {煤:100},
    ...
    "工具加工站": {
        ...
        basePrice: {铁: 500,石头: 500}, costGrowth: 1.15,
        consumes: {电力: 0.15}, 
    ...
    "石油发电厂": {
        ...
        basePrice:{建材:50,钢:50}, costGrowth:1.2,
    ...
    "太阳能板": {
        ...
        basePrice: {塑料: 30, 铜: 200}, costGrowth: 1.04,
        produces: (state) => {
    ...
    "电池": {
        ...
        basePrice: {铜: 300,铁: 300}, costGrowth: 1.2,
        caps: {电力: 200},
        desc: "储存电力"
    },
    "铀矿": {
        ...
        basePrice: {铁: 300,建材: 150}, costGrowth: 1.1,
    ...
    "裂变反应堆": {
        ...
        basePrice: {金属板: 100,铀: 30}, costGrowth: 1.15,
    ...
    "轨道电梯": {
        ...
        basePrice: {碳纤维: 5000, 钛: 3000, 金属板: 8000}, costGrowth: 1.08,
        consumes: {电力: 0.4},
        desc: "提升月球建筑产量",
        modifiers: [
    ...
    "氚燃料厂": {
        ...
        basePrice: {钛: 10000,碳纤维: 20000}, costGrowth: 1.12,
        produces: {核燃料: 0.4}, 
    ...
    "聚变反应堆": {
        ...
        basePrice: {金属板: 10000,碳纤维: 5000,核燃料: 1000}, costGrowth: 1.05,
        produces: {电力: 1.5}, 
        consumes: {核燃料: 0.30},
        desc: "通过核聚变产生大量清洁能源"
    },
