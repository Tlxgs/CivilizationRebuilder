...
const TECHS_CONFIG = {
    "伐木技术": { price: {科学: 5}, prereq: null, desc: "要致富，先撸树！",  researched: false },
    "采石技术": { price: {科学: 5}, prereq: ["伐木技术"], desc: "徒手挖石头", researched: false },
    "印刷术": { price: {科学: 10}, prereq: ["伐木技术"], desc: "印刷术是人类近代文明的先导，为知识的广泛传播、交流创造了条件。",  researched: false },
    "高效采石": { price: {科学: 400}, prereq: ["矿物学"], desc: "尝试优化开采石头的效率，解锁新的升级。",researched: false },
    "基础储存技术": { price: {科学: 10}, prereq: ["采石技术"], desc: "解锁仓库，让你可以储存少量资源。", researched: false },
    ...
    "铁制工具": { price: {科学: 200,铁: 50}, prereq: ["铁冶炼"], desc: "伐木场/采石场速度+30%",
        effect: {伐木场: {prodFactor: 0.30}, 采石场: {prodFactor: 0.30}},researched: false },
    "钢制工具": { price: {科学: 500,钢: 50}, prereq: ["炼钢技术"], desc: "伐木场/采石场速度+30%",
        effect: {伐木场: {prodFactor: 0.30}, 采石场: {prodFactor: 0.30}}, researched: false },
    "碳纤维工具": { price: {科学: 1200,碳纤维: 150}, prereq: ["碳纤维材料"], desc: "伐木场/采石场速度+50%",
        effect: {伐木场: {prodFactor: 0.50}, 采石场: {prodFactor: 0.50}}, researched: false },
    ...
    "煤矿生产": { price: {科学: 60}, prereq: ["石制工具"], desc: "解锁煤矿", researched: false },
    ...
    "铁冶炼": { price: {科学: 180,煤: 20}, prereq: ["煤矿生产"], desc: "在高温下，用还原剂将铁矿石还原得到生铁",researched: false },
    "管理学": { price: {科学: 200}, prereq: ["铁冶炼"], desc: "管理学是研究管理规律、方法与模式，以提升组织效益的综合性交叉学科。", unlocks: ["行政机关"], unlocksPolicies: ["基础资源政策"], researched: false },
    "军事理论": { price: {科学: 150}, prereq: ["管理学"], desc: "解锁军营，可以生产军备并发动战争。",researched: false },
    "军工技术":{ price: {科学: 800,钢: 200}, prereq: ["军事理论"], desc: "建设军工厂来提高战斗力", researched: false },
    "冶炼管理": { price: {科学: 300,铁: 20}, prereq: ["管理学"], desc: "解锁冶炼方式政策",  researched: false },
    "初等数学": { price: {科学: 200}, prereq: ["印刷术"], desc: "初等数学涵盖算术、代数、几何、三角学及概率统计等基础内容", researched: false },
    "微积分": { price: {科学: 300}, prereq: ["初等数学"], desc: "微积分是研究函数变化率和累积变化的数学分支，主要包括微分学、积分学及其应用。", unlocks: ["大学"], researched: false },
    ...
    "牛顿力学": { price: {科学: 200}, prereq: ["初等数学"], desc: "研究低速宏观弱引力下的物体运动规律。", researched: false },
    "相对论":{ price: {科学: 500}, prereq: ["牛顿力学"], desc: "时空是一个整体，也许我们有办法穿越时间。", researched: false },
    "电磁感应": { price: {科学: 250}, prereq: ["牛顿力学"], desc: "解锁蒸汽机，准确来说是蒸汽发电机。",  researched: false },
    ...
    "金属回收": { price: {科学: 600,金属板:20}, prereq: ["金属加工"], desc: "研究如何将制作的金属制品进行回收再利用",  researched: false },
    ...
    "疯狂科学":{
        ...
        effect: {大学: {capFactor: +0.05}, 伐木场: {prodFactor: -0.3}, 采石场: {prodFactor: -0.3}}, researched: false
    },
